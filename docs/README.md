...
| Файл | Назначение |
|------|------------|
| `docs/USER_COMMAND_UI.md` | **Интерфейс `/user` — управление доступом (стандарт HuntTech)** — секции списка, кнопки ✅/❌, разъяснения, ключи приглашений, активация при /start |
| `docs/README.md` | Этот файл — модули и общее описание |
...
`save_startup_marker`, `format_startup_changelog`, `bot_version`.
